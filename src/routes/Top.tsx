...
const Top: React.FC = () => {
  ...
  const [days, setDays] = useState([
    { label: '月', state: [{ day: 1, time: "00:00:00", checked: false }] },
    { label: '火', state: [{ day: 2, time: "00:00:00", checked: false }] },
    { label: '水', state: [{ day: 3, time: "00:00:00", checked: false }] },
    { label: '木', state: [{ day: 4, time: "00:00:00", checked: false }] },
    { label: '金', state: [{ day: 5, time: "00:00:00", checked: false }] },
    { label: '土', state: [{ day: 6, time: "00:00:00", checked: false }] },
    { label: '日', state: [{ day: 0, time: "00:00:00", checked: false }] },
  ]);
      ...
      if (selectedDays.length > 0) {
        ...
        if (diff < 0) {
          ...
          if (selectedDays.length > 1) {
            ...
            countdownDate.setDate(countdownDate.getDate() - 7 + selectedDays[1].day - selectedDays[0].day);
          }
        }
